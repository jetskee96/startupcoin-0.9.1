...
unsigned int pnSeed[] =
{
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7604f8ce, 0xffb38222, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "The Times 17/Apr/2014 Economic recovery brings interest rate rise closer";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1397699644;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 889664450;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000000935b24f0e26d30cd7ff13bece45bf544d40cdb4b7f9aa397dea2ff14"));
        assert(genesis.hashMerkleRoot == uint256("0xe08b270871608c55728c73faef7cf0ba0bbd3306692ffda4c388dcf9d0aac16c"));

        vSeeds.push_back(CDNSSeedData("188.226.195.133", "188.226.195.133"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("startupcoin.petertodd.org", "testnet-seed.startupcoin.petertodd.org"));

...
#ifndef H_STARTUPCOIN_SCRIPT
#define H_STARTUPCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CStartUpcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, StartUpcoin always counted CHECKMULTISIGs

StartUpcoin Core version 0.9.1 is now available from:

  https://startupcoin.org/bin/0.9.1/test/

This is a security update. It is recommended to upgrade to this release
as soon as possible.

It is especially important to upgrade if you currently have version 0.9.0
installed and are using the graphical interface OR you are using startupcoind from
...
installer (on Windows) or just copy over /Applications/StartUpcoin-Qt (on Mac) or
startupcoind/startupcoin-qt (on Linux).
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the StartUpcoin Core software:

StartUpcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/startupcoin/files/StartUpcoin/startupcoin-0.5.4/
...
http://gitorious.org/startupcoin/startupcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix StartUpcoin-Qt notifications under Growl 1.3.
Increase required age of StartUpcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxStartUpcoin properly when installing StartUpcoin-Qt over it. (Windows)

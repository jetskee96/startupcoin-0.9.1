StartUpcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/startupcoin/files/StartUpcoin/startupcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the StartUpcoin
...
New/changed settings (command-line or startupcoin.conf file)
--------------------------------------------------------

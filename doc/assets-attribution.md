The following is a list of assets used in the startupcoin source and their proper attribution.
...
* License: MIT
* Site: [https://startupcointalk.org/index.php?topic=15276.0](https://startupcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original startupcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/startupcoin.icns, src/qt/res/src/startupcoin.svg,
	src/qt/res/src/startupcoin.ico, src/qt/res/src/startupcoin.png,
	src/qt/res/src/startupcoin_testnet.png, docs/startupcoin_logo_doxygen.png,
